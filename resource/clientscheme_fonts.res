Scheme
{
	...
	Fonts
	{
		...
		"G_FontHuge"
		{
			"1"
			{
				"name"			"VCR OSD Mono" [$WINDOWS] // Primary font
				"name"			"VCR OSD Mono" [!$WINDOWS] // Primary font
		...
		"G_FontHuge_2"
		{
			"1"
			{
				"name"			"VCR OSD Mono" [$WINDOWS] // Secondary font
				"name"			"VCR OSD Mono" [!$WINDOWS] // Secondary font
		...
		"G_FontHealth"
		{
			"1"
			{
				"name"			"VCR OSD Mono" [$WINDOWS] // Health Font | Primary font
				"name"			"VCR OSD Mono" [!$WINDOWS] // Health Font | Primary font
		...
		"G_FontAmmo"
		{
			"1"
			{
				"name"			"VCR OSD Mono" [$WINDOWS] // Ammo Font | Primary font
				"name"			"VCR OSD Mono" [!$WINDOWS] // Ammo Font | Primary font
		...
		"G_FontDamage"
		{
			"1"
			{
				"name"			"VCR OSD Mono" [$WINDOWS] // Damage font | Primary font
				"name"			"VCR OSD Mono" [!$WINDOWS] // Damage font | Primary font
				"tall"			"20" // Damage size
				"weight"		"0"
				"additive"		"0"
		...
		"G_FontCritDamage"
		{
			"1"
			{
				"name"			"VCR OSD Mono" [$WINDOWS] // Crit damage font | Primary font
				"name"			"VCR OSD Mono" [!$WINDOWS] // Crit damage font | Primary font
		...
		"G_FontTargetIDHealth"
		{
			"1"
			{
				"name"			"VCR OSD Mono" [$WINDOWS] // Target ID health font | Primary font
				"name"			"VCR OSD Mono" [!$WINDOWS] // Target ID health font | Primary font
		...
		"G_FontKillfeed"
		{
			"1"
			{
				"name"		"VCR OSD Mono" // Killfeed font
				"tall"		"8" // Killfeed tall
		...
		"CloseCaption_Normal"
		{
			"1"
			{
				"name"		"VCR OSD Mono" [$WINDOWS] // Closed captions font | Secondary font
				"name"		"VCR OSD Mono" [!$WINDOWS] // Closed captions font | Secondary font
	...
	CustomFontFiles
	{
		...
		"3"
		{
			"font" "resource/VCR OSD Mono.ttf"
			"name" "VCR OSD Mono"
			"russian"
			{
				"range" "0x0000 0xFFFF"
		...
		"4" 
		{
			"font" "resource/VCR OSD MonoSecondary.ttf"
			"name" "VCR OSD Mono Secondary"
			"russian"
			{
				"range" "0x0000 0xFFFF"
		...
		"5" 
		{
			"font" "resource/VCR OSD MonoProfessor.ttf"
			"name" "VCR OSD Mono Professor"
			"russian"
			{
				"range" "0x0000 0x00FF"
		...
		"6" 
		{
			"font" "resource/VCR OSD MonoBuild.ttf"
			"name" "VCR OSD Mono"
			"russian"
			{
				"range" "0x0000 0xFFFF"
