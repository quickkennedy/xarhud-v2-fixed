...
Scheme
{
	Colors
	{
		...
		"G_ActiveWindow"			"54 0 106 255" // Active window bg color
		"G_InctiveWindow"			"54 0 106 255" // Inactive window bg color
		"G_TitleBg"					"191 0 208 255" // Title bg color
		"G_TitleText"				"0 255 255 255" // Title text color
		"G_Highlight"				"243 109 255 255" // Highlight color
		"G_ConsoleBg"				"33 0 35 255" // Console bg color
		"G_ListBg"					"54 0 106 255" // List bg color
		"G_Border"					"243 109 255 255" // Border color
		"G_Text"					"0 255 255 255" // Text color
		"G_HighlightText"			"0 255 255 255" // Highlight text color
		"G_SelectedText"			"0 255 255 255" // Selected text color
		"G_DisabledText"			"212 68 68 255" // Disabled text color
		"G_ButtonBg"				"114 0 124 255" // Button bg color
		"G_ButtonText"				"0 255 255 255" // Button text color
		"G_ButtonHoverBg"			"191 0 208 255" // Button hover bg color
		"G_ButtonHoverText"			"0 255 255 255" // Button hover text color
		"G_InputBg"					"67 0 71 255" // Input bg color
	    ...
	    "QuickListBGSelected"       "243 109 255 255" // Highlight color
