Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"243 109 255 255" // Highlight color
		"G_White"				"255 255 255 255"
		"G_Black"				"0 0 0 255"
		"G_Red"					"230 0 0 255"
		"G_Shadow"				"255 0 255 255" // Shadow color
		...
		"G_PanelBg"				"40 40 40 0" // Panel color
		"G_OpaquePanelBg"		"40 40 40 255" // Opaque Panel color
		"G_Warning"				"255 0 0 255" // Warning color
		"G_HealthValue"			"0 255 255 255" // Health value color
		"G_Overheal"			"0 255 0 255" // Overhealed health value color
		"G_LowHealthValue"		"255 255 0 255" // Low health value color
		"G_AmmoClipValue"		"0 255 255 255" // Ammo in clip value color
		"G_AmmoReserveValue"	"0 255 0 255" // Ammo in reserve value color
		"G_LowAmmo"				"255 255 0 255" // Low ammo color
		"G_MetalValue"			"0 255 0 255" // Metal color
		"G_MetalIcon"			"0 255 0 255" // Metal icon color
		"G_HeadsValue"			"0 255 255 255" // Heads value color
		"G_HeadsLabel"			"0 255 255 255" // Heads value icon color
		"G_KillstreakValue"		"255 255 0 255" // Killstreak value color
		"G_KillstreakIcon"		"255 255 0 255" // Killstreak icon color
		"G_StickyColor"					"105 0 255 255" // Stickybomb color
		"G_StickyIconColor"				"105 0 255 255" // Stickybomb icon color
		"G_CustomTargetID" 				"114 0 124 255" // Custom target id bg color
		"G_CustomBuildingStatusBg" 		"0 0 0 100" // Custom building status bg color
		"G_TargetHealthValue" 			"0 255 255 255" // Target ID health value color
		"G_TargetHealthValueShadow" 	"255 0 255 255" // Target ID health value shadow color
		...
		"G_Footer"					"30 0 62 255" // Menu footer color
		"G_DimmFooter"				"28 23 19 200" // Dimm Menu footer color
		"G_FooterText"				"243 109 255 255" // Footer text color
		"G_DimmFooterText"			"243 109 255 120" // Dimm Footer text color
		"G_OuterBorder"				"0 0 0 0" // Outer border color
		"G_InnerBorder"				"0 0 0 0" // Inner border color
		"G_KillfeedBlue"			"69 117 222 255" // Killfeed blue text
		"G_KillfeedRed"				"232 113 221 255" // Killfeed red text
		"G_KillfeedIcon"			"255 255 255 255" // Killfeed icon color
		"G_CustomHealthValue"		"120 120 120 255"
		"G_MainMenuOverlay"			"255 112 0 0" // Main Menu overlay color
		"G_MainMenuPanel"			"191 0 208 255" // Main Menu panel color
		"G_MainMenuButton"			"114 0 124 255" // Main Menu button color
		"G_MainMenuButtonHover"		"243 109 255 255" // Main Menu hovered button color
		"G_MainMenuButtonFg"		"0 255 255 255" // Main Menu button text color
		"G_MainMenuButtonHoverFg"	"0 255 255 255" // Main Menu hovered button text color
		"G_MainMenuShader" 			"54 0 106 255" // Main Menu shader color
		"G_BackpackItemBg"			"67 0 71 255" // Backpack item bg color
		"G_LoadoutItemBg"			"67 0 71 255" // Loadout item bg color
		"G_MenuBg"					"54 0 106 255" // Menu bg color
		"G_MenuText"				"243 109 255 255" // Menu text color
		"G_InputText"				"0 10 106 255" // Input text color
		"G_DimmInputText"			"0 10 106 100" // Dimm Input text color
		"G_DimmMenuText"			"243 109 255 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"67 0 71 255" // Item description panel bg
		"G_ButtonBg"				"114 0 124 255" // Button bg color
		"G_ButtonText"				"0 255 255 255" // Button text color
		"G_ButtonHoverBg"			"243 109 255 255" // Button hover bg color
		"G_ButtonHoverText"			"0 255 255 255" // Button hover text color
		"G_ButtonSelectedBg"		"162 0 184 255" // Button selected bg color
		"G_ButtonSelectedText"		"0 255 255 255" // Button selected text color
		...
		"G_ItemMeterBg"				"114 0 124 255" // Item meter bg
		"G_ItemMeterBorder"			"243 109 255 255" // Item meter border color
		"G_MenuShader"				"0 0 0 99" // Menu shader color
		"G_XPBar"					"240 0 255 255" // XP Bar color
		"G_ItemEffectMeterLineColor"	"120 120 120 130"
		"G_MvmLobbyPanelBg"			"40 40 40 255"
		"G_MvmLobbyPanelText"		"220 220 220 255"
		
		// Crosshairs
		"G_Crosshair1Color"		"0 255 255 255" // Crosshair1 color
		"G_Crosshair2Color"		"0 255 255 255" // Crosshair2 color
		"G_Crosshair3Color"		"240 0 255 255" // Crosshair3 color
		...
		"TFOrange"			"243 109 255 255" // Highlight color
		...
		"QualityColorrarity4"					"150 0 255 255" // IQC Unusual
		...
		"DimmQualityColorrarity4"				"150 0 255 100" // Dimm IQC Unusual
		...
		"ItemRarityMythical"					"255 131 71 255" // IRC Mythical
		"ItemRarityLegendary"					"195 60 210 255" // IRC Legendary
		...
		"DimmItemRarityMythical"					"255 131 71 100" // Dimm IRC Mythical
		"DimmItemRarityLegendary"					"195 60 210 100" // Dimm IRC Legendary
	...
	BaseSettings
	{
		...
		Slider.NobColor				"243 109 255 255" // Highlight color
		Slider.TextColor			"243 109 255 255" // Menu text color
		Slider.TrackColor			"243 109 255 255" // Menu text color
		Slider.DisabledTextColor1	"243 109 255 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"243 109 255 120" // Dimm Menu text color
